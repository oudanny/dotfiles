...
followed by the command `julia --project -e "using Pkg; Pkg.test()` at the command prompt.  A status message of `Test Summary: ... Test Passed` indicates you have the correct answer.
